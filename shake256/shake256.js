"use strict";
/**
 * JavaScript implementation of the SHAKE256 algorithm.
 * 
 ...
 * @file   This file defines the shake256 global constant.
 * @author Korosium
 */
const shake256 = (() => {
    ...
    /**
     * The default checksum length.
     */
    const DEFAULT_CHECKSUM_LENGTH = 64;
    ...
    const hash = (() => {
        ...
        return {
             ...
             * @param {number}                                       length The length of the resulting checksum in bytes. Default is 64 bytes.
             * 
             * @returns {number[]} The byte array checksum.
             */
            array(data, length = DEFAULT_CHECKSUM_LENGTH) {
                return keccak.keccak(data, R, length);
            },
             ...
             */
            hex(data, length = DEFAULT_CHECKSUM_LENGTH) {
                return conversion.to_hex(this.array(data, length));
            },
             ...
             */
            base64(data, length = DEFAULT_CHECKSUM_LENGTH) {
                return conversion.to_base64(this.array(data, length));
            }
