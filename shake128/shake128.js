"use strict";
/**
 * JavaScript implementation of the SHAKE128 algorithm.
 * 
 ...
 * @file   This file defines the shake128 global constant.
 * @author Korosium
 */
const shake128 = (() => {
     ...
     */
    const DEFAULT_CHECKSUM_LENGTH = 32;
    ...
    const hash = (() => {
        ...
        return {
             ...
             * @param {number}                                       length The length of the resulting checksum in bytes. Default is 32 bytes.
             * 
